...
VALUES
    ...
    -- Third level categories under '소설'
    ('현대 소설', 6),
    ('고전 소설', 6),
    ('미스터리 소설', 6),
    ('로맨스 소설', 6),
    ...
    -- Third level categories under '종교'
    ('기독교', 7),
    ('불교', 7),
    ('이슬람교', 7),
    ('힌두교', 7),
    ...
    -- Third level categories under '초등 참고서'
    ('수학', 8),
    ('과학', 8),
    ('국어', 8),
    ('사회', 8),
    ...
    -- Third level categories under '예술/대중문화'
    ('음악', 9),
    ('영화', 9),
    ('미술', 9),
    ('연극', 9),
    ...
    -- Third level categories under '중/고등 참고서'
    ('수학', 10),
    ('과학', 10),
    ('국어', 10),
    ('사회', 10),
    ...
    -- Third level categories under '기술/공학'
    ('기계공학', 11),
    ('전기공학', 11),
    ('전자공학', 11),
    ('건축공학', 11),
    ...
    -- Third level categories under '외국어'
    ('영어', 12),
    ('중국어', 12),
    ('일본어', 12),
    ('스페인어', 12),
    ...
    -- Third level categories under '과학'
    ('물리학', 13),
    ('화학', 13),
    ('생물학', 13),
    ('지구과학', 13),
    ...
    -- Third level categories under '취업/시험'
    ('공무원 시험', 14),
    ('자격증 시험', 14),
    ('기업 취업', 14),
    ('외국계 취업', 14),
    ...
    -- Third level categories under '여행'
    ('국내 여행', 15),
    ('해외 여행', 15),
    ('배낭여행', 15),
    ('패키지여행', 15),
    ...
    -- Third level categories under '문학'
    ('고전 문학', 16),
    ('현대 문학', 16),
    ('시', 16),
    ('드라마', 16),
    ...
    -- Third level categories under '취미/실용/여행'
    ('공예/DIY', 17),
    ('정원 가꾸기', 17),
    ('여행 가이드', 17),
    ('사진 촬영', 17),
    ...
    -- Third level categories under '생활/요리'
    ('요리', 18),
    ('건강/피트니스', 18),
    ('육아', 18),
    ('홈 인테리어', 18),
    ...
    -- Third level categories under '과학/기술'
    ('물리학', 19),
    ('화학', 19),
    ('생물학', 19),
    ('지구과학', 19),
    ...
    -- Third level categories under '비즈니스/경제'
    ('경영', 20),
    ('경제학', 20),
    ('재무/투자', 20),
    ('마케팅', 20),
    ...
    -- Third level categories under '컴퓨터/IT'
    ('프로그래밍', 22),
    ('네트워크', 22),
    ('데이터베이스', 22),
    ('웹 개발', 22),
    ...
    -- Third level categories under '역사/문화'
    ('세계사', 23),
    ('한국사', 23),
    ('고고학', 23),
    ('문화사', 23),
    ...
    -- Third level categories under '사회/정치'
    ('사회학', 24),
    ('정치학', 24),
    ('국제 관계', 24),
    ('법학', 24),
    ...
    -- Third level categories under '철학/종교'
    ('철학 일반', 25),
    ('동양 철학', 25),
    ('서양 철학', 25),
    ('종교 일반', 25),
    ...
    -- Third level categories under '만화'
    ('판타지 만화', 26),
    ('그래픽 노블', 26),
    ('웹툰', 26),
    ('연재 만화', 26),
    ...
    -- Third level categories under '어린이'
    ('그림책', 27),
    ('동화책', 27),
    ('교육용 책', 27),
    ('놀이 책', 27),
    ...
    -- Third level categories under '교육'
    ('교과서', 28),
    ('참고서', 28),
    ('문제집', 28),
    ('학습지', 28),
    ...
    -- Third level categories under '비즈니스'
    ('경영', 29),
    ('재무', 29),
    ('마케팅', 29),
    ('창업', 29),
    ...
    -- Third level categories under '자기계발'
    ('자기계발 일반', 31),
    ('리더십', 31),
    ('시간 관리', 31),
    ('동기부여', 31),
    ...
    -- Third level categories under '역사'
    ('세계사', 32),
    ('한국사', 32),
    ('고고학', 32),
    ('문화사', 32),
    ...
    -- Third level categories under '예술'
    ('음악', 35),
    ('영화', 35),
    ('미술', 35),
    ('연극', 35),
    ...
    -- Third level categories under '판타지'
    ('로맨스 만화', 36),
    ('SF 만화', 36),
    ('청소년 만화', 36),
    ('무협 만화', 36),
    ...
    -- Third level categories under '그래픽 노블'
    ('슈퍼히어로', 37),
    ('판타지', 37),
    ('공포', 37),
    ('논픽션', 37),
    ...
    -- Third level categories under '웹툰'
    ('로맨스', 38),
    ('액션', 38),
    ('코미디', 38),
    ('드라마', 38),
    ...
    -- Third level categories under '연재 만화'
    ('신문 만화', 39),
    ('웹툰', 39),
    ('역사 만화', 39),
    ('유머 만화', 39),
    ...
    -- Third level categories under '소년 만화'
    ('모험 만화', 40),
    ('스포츠 만화', 40),
    ('판타지 만화', 40),
    ('SF 만화', 40),
