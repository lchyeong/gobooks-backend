...
VALUES ('해커스 토익 Listening', 'David Cho', '9788965422781', '해커스 토익 Listening 교재는 최신 기출 경향을 반영한 실전 모의고사 문제와 해설, 그리고 Listening 전략을 포함하고 있습니다. 수많은 토익 수험생들이 선택한 이 교재는...', 14800, '2023-01-10', 'AVAILABLE', 100, '해커스 토익 Listening.jpeg', false),
       ...
       ('데미안', '헤르만 헤세', '9788937460440', '헤르만 헤세의 성장 소설로, 청소년과 성인의 경계에서 방황하는 주인공의 내면적 성장을 그린 작품입니다. 이 책은 인간 존재의 본질과 자아 찾기의 여정을 담고 있으며, ...', 12000, '2020-05-15', 'AVAILABLE', 30, '데미안.jpeg', false),
       ...
       ('자바 ORM 표준 JPA 프로그래밍', '김영한', '9788999415722', '김영한의 자바 ORM 표준 JPA 프로그래밍 책으로, JPA의 기본 개념부터 실전 예제까지 다루고 있습니다. 이 책은 엔티티 매핑, 연관 관계 매핑, JPQL 등 JPA ...', 45000, '2018-02-10', 'AVAILABLE', 90, '자바 ORM 표준 JPA 프로그래밍.jpeg', false),
       ...
       ('리팩토링 2판', '마틴 파울러', '9788966260962', '마틴 파울러의 리팩토링 책으로, 코드의 품질을 개선하는 방법을 다룹니다. 이 책은 리팩토링의 기본 개념부터 실전 예제까지 포함하고 있어 개발자들에게 유용한 정보를 제공합...', 42000, '2018-12-20', 'AVAILABLE', 100, '리팩토링 2판.jpeg', false),
       ...
       ('나는 나로 살기로 했다', '김수현', '9788965746353', '김수현 작가의 자존감 회복 에세이로, 자신을 사랑하고 당당하게 살아가는 방법을 제시합니다. 이 책은 일상 속 작은 변화들을 통해 행복을 찾고, 자존감을 높이는 방법을...', 13800, '2021-04-20', 'AVAILABLE', 150, '나는 나로 살기로 했다.jpeg', true),
       ...
       ('하버드 상위 1퍼센트의 비밀', '정주영', '9788954637162', '정주영 작가의 자기계발서로, 하버드 대학의 상위 1% 학생들이 실천하는 성공 비결을 소개합니다. 이 책은 공부 방법, 시간 관리, 목표 설정 등 다양한 주제를 다룹니다...', 17500, '2022-02-10', 'AVAILABLE', 170, '하버드 상위 1퍼센트의 비밀.jpeg', false),
       ...
       ('한 권으로 끝내는 디지털 마케팅', '황희철', '9788935703626', '황희철 작가의 자기계발서로, 디지털 마케팅의 기본 개념과 실전 전략을 소개합니다. 이 책은 소셜 미디어, 콘텐츠 마케팅, 데이터 분석 등 다양한 주제를 다루며, 마케터...', 20000, '2022-07-20', 'AVAILABLE', 100, '한 권으로 끝내는 디지털 마케팅.png', false),
       ...
       ('1cm 다이빙', '태영호', '9788994120706', '태영호 작가의 에세이로, 일상에서 발견하는 작은 행복을 이야기합니다. 이 책은 독자가 매일의 순간을 소중히 여기고, 작은 변화에서 큰 기쁨을 찾을 수 있도록 도와줍니다...', 13500, '2019-08-25', 'AVAILABLE', 140, '1cm 다이빙.jpeg', true),
       ...
       ('반지의 제왕: 반지 원정대', 'J.R.R. 톨킨', '9788982733014', '프로도 배긴스와 그의 친구들이 사우론의 반지를 파괴하기 위해 모험을 떠나는 이야기입니다.', 22000, '1954-07-29', 'AVAILABLE', 150, '반지의 제왕.jpeg', false),
       ...
       ('파친코', '이민진', '9788937463290', '20세기 초부터 전후 일본에 이르기까지, 한국 이민자 가족의 세대를 통해 드러나는 역사적 사건과 개인의 이야기를 그린 소설입니다.', 17000, '2017-04-25', 'AVAILABLE', 160, '파친코.jpeg', true),
       ...
       ('해변의 카프카', '무라카미 하루키', '9788954635119', '소년 카프카가 가출 후 겪는 신비롭고 초현실적인 사건들을 통해 성장하는 이야기를 담은 소설입니다.', 15000, '2002-09-12', 'AVAILABLE', 150, '해변의 카프카.jpeg', true),
       ...
       ('도쿄 타워', '릴리 프랭키', '9788972756194', '도쿄 타워 주변에서 벌어지는 다양한 인간 군상을 통해 현대 일본 사회를 그린 소설입니다.', 11000, '2002-12-15', 'AVAILABLE', 170, '도쿄 타워.jpeg', true),
